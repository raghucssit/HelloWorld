...
/**
 * This is the item provider adapter for a {@link addressbook.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AddressbookPackage.Literals.GROUP__NAME,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AddressbookPackage.Literals.GROUP__CONTACTS);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AddressbookPackage.Literals.GROUP__CONTACTS,
				 AddressbookFactory.eINSTANCE.createContact()));
	}
